...
public class bill extends menu{
    ...
    @FXML
    void initialize() {
        assert gst != null : "fx:id=\"gst\" was not injected: check your FXML file 'Untitled.fxml'.";
        ...
        assert ta != null : "fx:id=\"ta\" was not injected: check your FXML file 'Untitled.fxml'.";
