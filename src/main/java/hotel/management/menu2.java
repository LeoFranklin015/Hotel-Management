...
public class menu2 {
    ...
    void add1(ActionEvent event) {
        try 
        {
			...
			String sql="update menu2 set quantity="+q1+" where id=1";
    ...
    void add2(ActionEvent event) {
        try 
        {
            ...
            Class.forName("com.mysql.cj.jdbc.Driver");
			final Connection con = DriverManager.getConnection("jdbc:mysql://localhost:3306/db","root",passwd);
			String sql="update menu2 set quantity="+q2+" where id=2";
			PreparedStatement ps = con.prepareStatement(sql);
            ps.executeUpdate();
        }
        catch(Exception e)
    ...
    void add3(ActionEvent event) {
        try 
        {
            ...
            Class.forName("com.mysql.cj.jdbc.Driver");
			final Connection con = DriverManager.getConnection("jdbc:mysql://localhost:3306/db","root",passwd);
			String sql="update menu2 set quantity="+q3+" where id=3";
			PreparedStatement ps = con.prepareStatement(sql);
            ps.executeUpdate();
        }
        catch(Exception e)
    ...
    void add4(ActionEvent event) {
        try 
        {
            ...
            Class.forName("com.mysql.cj.jdbc.Driver");
			final Connection con = DriverManager.getConnection("jdbc:mysql://localhost:3306/db","root",passwd);
			String sql="update menu2 set quantity="+q4+" where id=4";
			PreparedStatement ps = con.prepareStatement(sql);
            ps.executeUpdate();
        }
        catch(Exception e)
    ...
    void add5(ActionEvent event) {
        try 
        {
            ...
            Class.forName("com.mysql.cj.jdbc.Driver");
			final Connection con = DriverManager.getConnection("jdbc:mysql://localhost:3306/db","root",passwd);
			String sql="update menu2 set quantity="+q5+" where id=5";
			PreparedStatement ps = con.prepareStatement(sql);
            ps.executeUpdate();
        }
        catch(Exception e)
    ...
    void add6(ActionEvent event) {
        try 
        {
            ...
            Class.forName("com.mysql.cj.jdbc.Driver");
			final Connection con = DriverManager.getConnection("jdbc:mysql://localhost:3306/db","root",passwd);
			String sql="update menu2 set quantity="+q6+" where id=6";
			PreparedStatement ps = con.prepareStatement(sql);
            ps.executeUpdate();
        }
        catch(Exception e)
    ...
    void add7(ActionEvent event) {
        try 
        {
            ...
            Class.forName("com.mysql.cj.jdbc.Driver");
			final Connection con = DriverManager.getConnection("jdbc:mysql://localhost:3306/db","root",passwd);
			String sql="update menu2 set quantity="+q7+" where id=7";
			PreparedStatement ps = con.prepareStatement(sql);
            ps.executeUpdate();
        }
        catch(Exception e)
    ...
    void add8(ActionEvent event) {
        try 
        {
            ...
            Class.forName("com.mysql.cj.jdbc.Driver");
			final Connection con = DriverManager.getConnection("jdbc:mysql://localhost:3306/db","root",passwd);
			String sql="update menu2 set quantity="+q8+" where id=8";
			PreparedStatement ps = con.prepareStatement(sql);
            ps.executeUpdate();
        }
        catch(Exception e)
    ...
    void checkStatus(ActionEvent event) {
        try
        {
            Class.forName("com.mysql.cj.jdbc.Driver");
			final Connection con = DriverManager.getConnection("jdbc:mysql://localhost:3306/db","root",passwd);
			String sql="select status from menu2 where id=1";
			PreparedStatement ps = con.prepareStatement(sql);
